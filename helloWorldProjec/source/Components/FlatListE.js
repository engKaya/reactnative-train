...
import {Platform, StyleSheet,Text, View, SafeAreaView,TextInput,TouchableOpacity ,Image, FlatList} from 'react-native';
...
export default class FlatListE extends Component {
  state = {
    text:'',
    contacts:data
  }
